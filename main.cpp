...
Camera* camera = new Camera(glm::vec3(0.0f, 2.5f, 4.0f), glm::vec3(0.0f, 1.0f, 0.0f), -90.0f, -25.0f);
...
int main()
{
	...
	Billboard* billboard = new Billboard(camera, screenWidth, screenHeight, "resources/transparent_grid_2.png", "shaders/shaderBillboard.vertex", "shaders/shaderBillboard.frag");

	utils->initRandomDataBillboards(6);
	
	Geodesicsphere* geodesicSphere = new Geodesicsphere(camera, screenWidth, screenHeight);
	geodesicSphere->createGeodesicsphereShader();
	geodesicSphere->createGeodesicsphereGeom();
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//geodesicSphere->renderGeodesicsphereGeom(glm::vec3(0.0, 1.0, 0.0), 1.0f, glm::vec3(1.0, 0.0, 0.0), toggleModeDraw);
		geodesicSphere->renderAdvancedGeodesicsphere(glm::vec3(0.0, 0.0, 0.0), 1.0f, glm::vec3(20.0f, 20.0f, 20.0f), glm::vec3(0.0, 1.0, 0.0), toggleModeDraw);
		
		/*
		for (int i = 0; i < utils->billbRandomDataList.size(); ++i) {
			billboard->renderBillboardGeom(camera, utils->billbRandomDataList[i]._position, utils->billbRandomDataList[i]._scale, utils->billbRandomDataList[i]._distance, toggleModeDraw);
		}
		*/
